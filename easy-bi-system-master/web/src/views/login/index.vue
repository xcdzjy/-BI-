  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      <div v-if="isLogin">
        ...
        <div class="tips">
          <span style="margin-right:20px;" @click="isLogin = !isLogin">注册</span>
        </div>
      </div>
      <div v-else>
        <div class="title-container">
        ...
        <div class="tips">
          <span style="margin-right:20px;" @click="isLogin = !isLogin">返回</span>
        </div>
      </div>
    </el-form>
  </div>
...
export default {
  ...
  methods: {
    getCaptcha() {
      getcaptcha(this.loginForm.username).then(res => {
        if (res.code === 226) {
          this.$notify({
            title: 'error',
            message: '用户名已被占用',
